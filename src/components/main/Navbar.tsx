  ...
  return (
    ...
    "
      >
        ...
        "
          >
            <a href="https://www.codewars.com/users/Alex43bg" target="_blank" className="w-[30px] h-[25px] rounded-[8px]">
            <svg fill="#FF5C5C" width="28px" height="28px" viewBox="0 0 24 24" role="img" xmlns="http://www.w3.org/2000/svg">
